...
7. Keep each input string under 50 characters where possible — short and punchy, not a full descriptive sentence. No quotation marks, no emojis, no exclamation points. Style reference (these show the SHAPE, not literal answers to reuse — always generate suggestions tailored to the actual goal you receive, never copy these examples verbatim regardless of what the input goal is): "Complete 30 minutes of French lesson or immersion app" → "30 minutes of a French app or podcast"; "Read 30 minutes of a book today" → "Read 30 minutes of a book". Strip filler words but keep the measurability intact (must still contain a number, duration, or clear done/not-done criterion).
