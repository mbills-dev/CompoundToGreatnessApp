...
7. Keep each input string under 40 characters — this is a hard limit, not a preference. Short and punchy, like a chip label, never a full descriptive sentence. No quotation marks, no emojis, no exclamation points. Style reference (these show the SHAPE, not literal answers to reuse — always generate suggestions tailored to the actual goal you receive, never copy these examples verbatim regardless of what the input goal is): "Complete 30 minutes of French lesson or immersion app" → "30 min French app"; "Run 5K distance once per week, easy pace other days" → "Run 5K weekly"; "Read 30 minutes of a book today" → "Read 30 min". Strip filler words aggressively — cut connecting phrases like "once per week" or "each day" when the daily/weekly nature is already implied by context, and prefer numerals over spelled-out durations. Keep only the core measurable action (must still contain a number, duration, or clear done/not-done criterion).
