...
9. If path is "numbers", also determine "numbersSubtype":
   - "funnel": a goal reached through a genuine sales, outreach, or conversion process where attempts × conversion-rate = wins, and each win has a discrete value. This includes revenue, income, deals closed, clients signed, sales calls made, cold outreach converting to leads or subscribers, etc. The goal text should imply an active conversion mechanism — selling, pitching, converting, outreach — not just a raw count.
   - "direct": a cumulative-output goal with NO conversion step. Each unit of effort directly produces a unit of output. This includes organic audience/follower/subscriber growth (YouTube, Instagram, TikTok, email list growth through content rather than outreach), word counts, pages read, vocabulary words learned, square feet painted, dollars saved, debt paid off, books read, lines of code written, drawings completed, step counts, or any goal that's just "reach this total number" with no sales mechanism involved. The progress mechanism is: daily_output × days = total_output.
   Only choose "funnel" when the goal text genuinely implies an active sales, outreach, or conversion process. A goal that's just a target count or total (subscribers, followers, words, dollars saved) with no mention of selling, pitching, or converting should default to "direct", even if the underlying category (subscribers, revenue-sounding nouns) could theoretically involve a funnel in some other context.
   Contrastive examples: "50,000 YouTube subscribers" → direct (organic growth, no conversion mechanism). "Grow my email list to 10,000 subscribers through cold outreach" → funnel (explicit outreach/conversion process stated).
