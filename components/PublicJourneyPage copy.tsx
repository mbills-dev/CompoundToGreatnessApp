      ...
      >
            ...
            {isPreStart ? (
              ...
              <View style={styles.heroStatsCard}>
                ...
                <View style={styles.heroStatHalf}>
                  ...
                  <Text style={styles.statLabel}>OF 77</Text>
                </View>
              </View>
            )}
          </LinearGradient>
          ...
          <View style={styles.identitySection}>
            ...
            <View style={styles.identityQuoteBlock}>
              ...
              <View style={styles.identityCopy}>
                {(identityLines.length ? identityLines : [journey.identityStatement]).map((line, index) => (
        ...
        {journey?.allowPublicEncouragements && (
          <View style={styles.encouragementCard}>
            ...
            <Text style={styles.encouragementHeadline}>THEY'VE SHOWN UP{`\n`}FOR {journey?.realStreak ?? 0} DAYS.</Text>
...
const styles = StyleSheet.create({
  ...
  heroCard: { minHeight: 440, borderRadius: 28, overflow: 'hidden', marginBottom: 44, backgroundColor: '#111' },
  ...
  proofStatus: { width: 28, height: 28, borderRadius: 14, borderWidth: 2, borderColor: '#2B2B2B', alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  ...
  stackActivityIncomplete: { color: '#4D4D4D' },
